...
assert.equal(challengeConfig(6).preview, 0);
assert.equal(challengeConfig(6).mismatchDelay, 650);
assert.equal(challengeConfig(11).mismatchDelay, 600);
assert.equal(challengeConfig(100).mismatchDelay, 300);
assert.equal(challengeConfig(10).hideCode, false);
assert.equal(challengeConfig(11).hideCode, true);
assert.equal(challengeConfig(16).hideSymbol, true);
assert.equal(challengeConfig(21).hideLabel, true);
