...
assert.ok(index.includes('./mobile-battle-ui.js?v=20260918-2'), "Step 9 mobile controller is loaded");
assert.ok(
...
assert.ok(
  index.indexOf('mobile-battle-ui.js?v=20260918-1') < index.indexOf('bootstrap.js?v='),
